...
class BaseModelOutput(ModelOutput):
    ...
    prune_losses: Optional[Tuple[torch.FloatTensor]] = None
    out_hidden_states_for_loss: Optional[List[torch.FloatTensor]] = None
    target_area_masks: Optional[List[torch.FloatTensor]] = None
...
class BaseModelOutputWithPast(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    text_image_attn_weights_list: Optional[List[torch.FloatTensor]] = None
